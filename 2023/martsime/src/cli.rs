...
pub fn get_function(day: u8, part: u8) -> fn() -> Solution {
    match (day, part) {
        ...
        (16, 1) => crate::day16::part01,
        (16, 2) => crate::day16::part02,
        (17, 1) => crate::day17::part01,
        (17, 2) => crate::day17::part02,
        (18, 1) => crate::day18::part01,
        (18, 2) => crate::day18::part02,
        (_, _) => unimplemented!(),
    }
}
