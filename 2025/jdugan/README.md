...
[2025 Advent of Code](https://adventofcode.com/2025) using Python.
...
The project requires `python 3.14.0`, but any reasonably current version of
...
- [src](./src):     Puzzle solutions and data organised by day
